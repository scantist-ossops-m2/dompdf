...
class Options
{
    ...
    */
    ...
    {
        if ($this->artifactPathValidation === null || ($this->artifactPathValidation)($fontCache, "fontCache") === true) {
    ...
    {
        if ($this->artifactPathValidation === null || ($this->artifactPathValidation)($fontDir, "fontDir") === true) {
    ...
    {
        if ($this->artifactPathValidation === null || ($this->artifactPathValidation)($logOutputFile, "logOutputFile") === true) {
    ...
    {
        if ($this->artifactPathValidation === null || ($this->artifactPathValidation)($tempDir, "tempDir") === true) {
    ...
    {
        if ($this->artifactPathValidation === null || ($this->artifactPathValidation)($rootDir, "rootDir") === true) {
